# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 16:38:51 2022
  * audio basic
  * to waveform  decode_wav
  * to spectrogram  stft
...
# Split filenames into training, validation and test sets using a 80:10:10 ratio
...
# The shape of the tensor returned by tf.audio.decode_wav is [samples, channels], where channels is 1 for mono or 2 for stereo
...
# The waveforms in the dataset are represented in the time domain. Next, you'll transform the waveforms from the time-domain signals into the time-frequency-domain signals by computing the short-time Fourier transform (STFT) to convert the waveforms to as spectrograms, which show frequency changes over time and can be represented as 2D images.
